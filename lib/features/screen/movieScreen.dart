...
class MovieScreen extends StatefulWidget {
  ...
  const MovieScreen({Key? key, required this.cards}) : super(key: key);

  @override
  State<MovieScreen> createState() => _ChurchScreenState();
}

class _ChurchScreenState extends State<MovieScreen> {
  @override
